...
class _AddProjectDialogState extends State<AddProjectDialog> {
  ...
  void _submit() {
    ...
    context.read<ProjectProvider>().addProject(name: name, description: _descController.text.trim().isEmpty ? null : _descController.text.trim(), color: _selectedColor, priority: _priority);
